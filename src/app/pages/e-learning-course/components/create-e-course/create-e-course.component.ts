...
export class CreateECourseComponent implements OnInit {
  ...
  controlNames = {
    ...
    overviewDescription: 'course_overview',
    categoryId: 'category',
    teacherId: 'teacher',
    price30Day: 'price_30_days',
    price30DayOld: 'old_price_30_days',
    price90Day: 'price_90_days',
    price90DayOld: 'old_price_90_days',
    price180Day: 'price_180_days',
    price180DayOld: 'old_price_180_days',
    price365Day: 'price_365_days',
    price365DayOld: 'old_price_365_days',
    priceForever: 'price_lifetime',
    priceForeverOld: 'old_price_lifetime',
    completedPoint: 'accumulated_points',
    type: 'course_type',
    memberPolicyLevelId: 'minimum_membership_package',
    level: 'course_level',
    language: 'language',
    introVideo: 'introduction_video_link',
    imgBanner: 'banner',
